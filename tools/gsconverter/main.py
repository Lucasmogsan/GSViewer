...
if __name__ == "__main__":
    ...
    # parser.add_argument("--input", "-i", required=True, default="input_cc.ply", help="Path to the source point cloud file.")
    # parser.add_argument("--output", "-o", required=True, default="output_3dgs.ply", help="Path to save the converted point cloud file.")
    # parser.add_argument("--target_format", "-f", choices=["3dgs", "cc"], required=True, default="3dgs", help="Target point cloud format.")
    
    # #3dgs to cc
    # parser.add_argument("--input", "-i", required=False, default=r"D:\small_tools_python\GS_Viewer\测试data\iteration_7000\point_cloud.ply", help="Path to the source point cloud file.")
    # parser.add_argument("--output", "-o", required=False, default=r"D:\small_tools_python\GS_Viewer\测试data\iteration_7000\exportCC\output_cc.ply", help="Path to save the converted point cloud file.")
    # parser.add_argument("--target_format", "-f", choices=["3dgs", "cc"], required=False, default="cc", help="Target point cloud format.")
    
    # cc to 3dgs
    parser.add_argument("--input", "-i", required=False, default=r"D:\small_tools_python\GS_Viewer\测试data\iteration_7000\cc\output_3dgs.ply", help="Path to the source point cloud file.")
    parser.add_argument("--output", "-o", required=False, default=r"D:\small_tools_python\GS_Viewer\测试data\iteration_7000\export3DGS\output_3dgs.ply", help="Path to save the converted point cloud file.")
    parser.add_argument("--target_format", "-f", choices=["3dgs", "cc"], required=False, default="3dgs", help="Target point cloud format.")
    ...
    # Other flags
    parser.add_argument("--rgb", action="store_true", required=False, default=False, help="Add RGB values to the output file based on f_dc values (only applicable when converting to Cloud Compare format).")
